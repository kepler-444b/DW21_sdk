...
// sds add (2025.05.09)
/************** software version **************/
#define MODEM_VERSION_NV (0x76)
#define KEEP_STATUS_NV (0x92)
...
typedef struct
{
    td_u16 fault_status; /* 故障状态 */
    td_u16 soft_ver;     /* 软件版本 */
    td_u16 firmware_ver; /* 固件版本 */
    td_u16 prot_type;    /* 协议类型 */
    td_u16 prot_ver;     /* 设备协议版本 */
    td_u16 reserve_ext;
    td_u32 reserve[8];
} modem_version_nv;
