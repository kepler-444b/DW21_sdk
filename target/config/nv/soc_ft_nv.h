...
// #define EXT_NV_FTM_RESERVE_ID_8 (0x08)       // 在下方重新定义
...
// sds add (2025.05.09)
/************** device info **************/
#define EXT_NV_FTM_DEVICE_INFO (0x08)
...
typedef struct
{
    td_u16 dev_category;    /* 设备类别 */
    td_u16 dev_type;        /* 设备类型 */
    td_u8 dev_type_ext[4];  /* 设备类型扩展 */
    td_u32 dev_prodId;      /* ProductId:0x1001-0x1130 */
    td_u8 dev_manu[4];      /* 制造商 */
    td_u16 hardware_ver;    /* 硬件版本 */
    td_u8 dev_model[34];    /* D21S-R */
    td_u32 reserve[8];      /* 保留字段 */
    
} ext_nv_ftm_device_id;
